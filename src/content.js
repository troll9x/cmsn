...
export const CONTENT = {
  ...
  ui: {
    dedication: PROFILE.birthday ? '♥ HAPPY BIRTHDAY TO MY LOVE ♥' : 'DÀNH RIÊNG CHO SINH NHẬT CHI',
  ...
  scenes: [
    ...
    },
    {
      ...
      paragraphs: ['Giữa rất nhiều ngã rẽ cuộc đời,\nÔng trời lại để hai ta gặp được nhau giữa bao nhiêu người.', 'Có lẽ, đó là định mệnh.\nVà điều khiến {sender} vui hơn cả,\nlà ngày hôm nay {sender} được ở đây\nđể dành những lời chúc tốt đẹp nhất cho {recipient}.'],
      interactions: ['{senderCapital} nghĩ đây là “ý trời”. Cảm ơn {recipient} đã xuất hiện và khiến những ngày bình thường của {sender} trở nên đặc biệt hơn!'],
      caption: 'Giữa rất nhiều ngã rẽ,', captionItalic: 'thật vui vì đã gặp được nhau.',
    },
    {
      id: 'distance', label: 'Có em', title: 'Có {recipient},\nngày vui hơn.',
      mobileTitle: 'Từ khi {recipient}\nxuất hiện...',
      paragraphs: ['{senderCapital} không nhớ từ khi nào,\nđược cuộc trò chuyện cùng với {recipient}\nđã trở thành niềm vui của anh.', 'Chỉ một tin nhắn, một câu chuyện,\nhay đôi lúc chợt nghĩ đến {recipient} —\ncũng đủ khiến {sender} mỉm cười.'],
    ...
    },
    {
      ...
      paragraphs: ['Thêm một tuổi mới,\n{sender} mong {recipient} lúc nào cũng luôn xinh đẹp, tự tin\nvà hạnh phúc.', 'Mong {recipient} có những ngày, tháng thật vui,\nđạt được những giấc mơ của mình,\nvà có những khoảnh khắc mà khi nhớ lại,\n{recipient} vẫn khiến em khẽ mỉm cười thật lâu.'],
      caption: 'Tuổi mới của {recipient},', captionItalic: 'mong sẽ rạng rỡ như chính nụ cười ấy.',
    },
    {
      id: 'gift', label: 'Hẹn em tối nay', title: 'Ở cuối\nhành trình này...',
      mobileTitle: 'Ở cuối\nhành trình này...',
      paragraphs: ['Anh vẫn còn đôi lời muốn dành riêng cho {recipient}.\nChạm nhẹ để đọc nhé.'],
